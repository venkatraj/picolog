  ...
  $theme_data = wp_get_theme('picolog'); 
    ...
    <div class="picolog-wrapper about-wrap">
	   ...
	   <h2 class="nav-tab-wrapper">
			...
			<a href="?page=picolog_upgrade&tab=one_click_demo" class="nav-tab<?php echo $tab == 'one_click_demo' ? ' nav-tab-active' : null; ?>"><?php esc_html_e( 'Import Demo Data', 'picolog' );  ?></a>	        
            ...
            <div class="theme_info info-tab-content">
                <div class="theme_info_column clearfix">
                	<div id="webulous-create-web">
	                	<a href="https://www.webulousthemes.com/checkout?edd_action=add_to_cart&download_id=23052" target="_blank">
							...
							<div class="image-wrap">
								<?php echo sprintf ( '<img src="'. get_template_directory_uri() .'/images/api.png" alt="%1$s" />',__('Image','picolog') ); ?>
							</div>
						</a>
					</div>
                    ...
                    <div class="theme_info_right">
                        <?php echo sprintf ( '<img src="'. get_template_directory_uri() .'/screenshot.png" alt="%1$s" />',__('Theme screenshot','picolog') ); ?>
                    </div>
                </div>
            </div>
        <?php } ?>
