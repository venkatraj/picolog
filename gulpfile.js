...
gulp.task( 'translate', function () {   
     return gulp.src( './**/*.php')
       ...
       .pipe(wpPot( {
           domain        : 'picolog',
           destFile      : 'picolog.pot',
           package       : 'picolog'
       } ))
      .pipe(gulp.dest('languages/picolog.pot'))
});  
...
gulp.task('clean', function() {
  return del(['images','languages/picolog.pot','rtl.css']);      
}); 
...
gulp.task('watch',function(){  
  browserSync.init({  
    files: ['./**/*.php'],    
    proxy: 'http://localhost/new/picolog',
  }); 
